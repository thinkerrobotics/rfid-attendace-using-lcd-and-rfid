...
const char *GScriptId = "AKfycbx-itu0ThX3pdaYKchQ02ltzH-oeAqOu5mha4PGa6QK3jpHqvBV12tsp65XGLDVoNzQ";
String gate_number = "Gate1";
//---------------------------------------------------------------------------------------------------------
// Enter network credentials:
const char* ssid     = "TEOXHAM -2.4Ghz";
const char* password = "S0ham@2016";
//---------------------------------------------------------------------------------------------------------
